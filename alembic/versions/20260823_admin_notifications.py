...
def downgrade() -> None:
    op.drop_index(op.f('ix_admin_notification_reads_user_id'), table_name='admin_notification_reads')
    op.drop_index(op.f('ix_admin_notification_reads_notification_id'), table_name='admin_notification_reads')
    op.drop_index(op.f('ix_admin_notification_reads_id'), table_name='admin_notification_reads')
