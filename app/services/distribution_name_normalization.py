...
_DISTRIBUTION_EQUIVALENT_BY_KEY: dict[str, str] = {
    ...
    "imprevus طواري": "emergency_buffer",
    "طواري": "emergency_buffer",
    "الطواري": "emergency_buffer",
    "الباقي الحر": "free_balance",
    ...
    "flex": "flexibility",
    "قرض السكن": "credit_logement",
    "credit logement": "credit_logement",
    "المازوط": "carburant",
    "carburant": "carburant",
    "تأمين الطوموبيل": "assurance_auto",
    "assurance auto": "assurance_auto",
    "صيانة الطوموبيل": "entretien_auto",
    "entretien auto": "entretien_auto",
    "الباركينغ": "parking",
    "parking": "parking",
    "قرض الطوموبيل": "credit_auto",
    "credit auto": "credit_auto",
    "الفحص التقني": "controle_technique",
    "controle technique": "controle_technique",
    "ضريبة الطوموبيل": "taxe_auto",
    "taxe auto": "taxe_auto",
    "مازوط الموطور": "carburant_2_roues",
    "carburant 2 roues": "carburant_2_roues",
    "تأمين الموطور": "assurance_2_roues",
    "assurance 2 roues": "assurance_2_roues",
    "صيانة الموطور": "entretien_2_roues",
    "entretien 2 roues": "entretien_2_roues",
    "أنشطة الوليدات": "activites_enfants",
    "activites enfants": "activites_enfants",
    "الحضانة": "garde",
    "garde": "garde",
    "حوايج الوليدات": "vetements_enfants",
    "vetements enfants": "vetements_enfants",
}
