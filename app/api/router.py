...
from app.api.routes.analytics import router as analytics_router, pulse_router
...
api_router.include_router(reports_router, tags=["reports"], dependencies=_GUEST_LOCKED)
