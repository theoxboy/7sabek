...
async def advisor_chat(
    ...
    base_system = (
        ...
        "   - If their envelopes are all at 0 DH and there is no income or balance in the data, DO NOT invent a starting amount. Ask the user how much money they have to split, then help them allocate it across their specific envelopes.\n"
        "   - AMOUNTS DISCIPLINE (CRITICAL): never state, assume, imply or use as an example any monetary figure that is not explicitly present in USER FINANCIAL DATA. Never say things like 'your 13,000 DH' unless that exact number is in the data. If you need an amount you don't have, ask for it.\n"
        "   - Never invent transactions, balances or amounts not present in the data.\n\n"
